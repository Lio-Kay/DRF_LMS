...
urlpatterns = [
    ...
    path('sections/<int:pk>/', SectionsRetrieveAPIView.as_view(), name='section_detail'),
    path('materials/', MaterialsListAPIView.as_view(), name='materials_list'),
    path('materials/<int:pk>/', MaterialsRetrieveAPIView.as_view(), name='material_detail'),
    path('materials/<int:pk>/test/', StartTest.as_view(), name='material_test'),
]
